...
| 4 | In a new task in each app, ask: "What does the bridge give you?" If Claude asks to allow imported instruction files, allow it. | It names the portable instructions, its own overlay and shared knowledge. |
